...
namespace Anna.Request
{
    public class Request
    {
        ...
        public Encoding ContentEncoding
        {
            get
            {
                if (request.ContentEncoding != Encoding.Default)
        ...
        public bool IsWebSocketRequest
        {
            get
            {
                return this.request.IsWebSocketRequest;
            }
        }
        ...
        public IObservable<string> GetBody(int maxContentLength = 50000)
        {
            ...
            var ret = Observable.FromAsync(() => InputStream.ReadAsync(buffer, 0, bufferSize))
                .Select(t => ContentEncoding.GetString(buffer, 0, t));
